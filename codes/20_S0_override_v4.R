...
log_file <- file.path(out_dir, "S0_manual_v4.log")
cat("", file = log_file)  # clear once at start
...
export_cu(df_w1, "notrend_GVAKN")
export_cu(df_w2, "trend_GVAKN")
